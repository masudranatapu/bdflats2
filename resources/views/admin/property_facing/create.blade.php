...
@section('title') {{ __('Property Facing | Create') }} @endsection
@section('page-name') {{ __('Property Facing | Create') }} @endsection
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-dashboard">
                                {!! Form::open([
                                    'route' => 'admin.propertyfacing.store',
                                    'method' => 'post',
