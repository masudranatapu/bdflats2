...
@section('title') {{ __('Area Create') }} @endsection
@section('page-name') {{ __('Area Create') }} @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item active">{{ __('Area Create') }}</li>
@endsection
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                {!! Form::select('city', $data['cities'] ?? [], old('city'), [
                                                    'id' => 'city',
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('area_name', old('area_name'), [
                                                    'class' => 'form-control',
                                                    'data-validation-required-message' => 'This field is required',
