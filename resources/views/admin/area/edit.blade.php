...
@section('title') Area | Update @endsection
@section('page-name') Area | Update @endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-dashboard">
                            {!! Form::open([ 'route' => ['admin.area.update', $data['area']->id], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        {!! Form::label('city', 'City *', ['class' => 'label-title']) !!}
                                        <div class="controls">
                                            {!! Form::select('city', $data['cities'] ?? [], old('city', $data['area']->f_city_no), ['id' => 'city', 'class' => 'form-control select2', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'City']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('latitude', old('latitude', $data['area']->lat), ['class' => 'form-control', 'placeholder' => 'Latitude']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('longitude', old('longitude', $data['area']->lon), ['class' => 'form-control', 'placeholder' => 'Longitude']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('order', old('order', $data['area']->order_id), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Order']) !!}
