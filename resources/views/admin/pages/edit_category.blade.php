    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Edit pages category') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('Edit pages category') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row  mb-2">
                                    <div class="col-12">
                                        {!! Form::open([
                                            'route' => ['admin.pages-category.update', $data['category']->id],
                                            'method' => 'post',
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {!! $errors->has('category_name') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        ...
                                                        {!! Form::text('category_name', old('category_name', $data['category']->name), [
                                                            'class' => 'form-control',
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {!! $errors->has('order_id') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        ...
                                                        {!! Form::number('order_id', old('order_id', $data['category']->order_id), [
                                                            'class' => 'form-control',
                                                            'data-validation-required-message' => 'This field is required',
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {!! $errors->has('meta_keywords') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        ...
                                                        {!! Form::text('meta_keywords', old('meta_keywords', $data['category']->meta_keywards), [
                                                            'class' => 'form-control',
                                                            'data-validation-required-message' => 'This field is required',
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {!! $errors->has('property_for') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        ...
                                                        {!! Form::select('property_for', $property_for ?? [], old('property_for', $data['category']->property_for), [
                                                            'class' => 'form-control',
                                                            'data-validation-required-message' => 'This field is required',
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group {!! $errors->has('meta_description') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        ...
                                                        {!! Form::textarea('meta_description', old('meta_description', $data['category']->meta_description), [
                                                            'class' => 'form-control',
                                                            'data-validation-required-message' => 'This field is required',
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group {!! $errors->has('status') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::radio('status', '1', $data['category']->is_active == 1, [
                                                            'id' => 'active',
                                                            'data-validation-required-message' => 'This field is required',
                                                            'checked' => 'checked',
                                                        ]) !!}
