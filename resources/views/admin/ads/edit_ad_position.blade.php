                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    {!! Form::open([
                                        'route' => ['admin.ads_position.update', $data['position']->id],
                                        'method' => 'post',
                                        'files' => true,
                                        'novalidate',
                                        'autocomplete' => 'off',
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    ...
                                                    {!! Form::text('name', old('name', $data['position']->name), [
                                                        'class' => 'form-control',
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {!! $errors->has('position') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    ...
                                                    {!! Form::number('position', old('position', $data['position']->position_id), [
                                                        'class' => 'form-control',
                                                        'data-validation-required-message' => 'This field is required',
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {!! $errors->has('status') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    ...
                                                    {!! Form::select('status', $status, old('status', $data['position']->is_active), [
