            ...
            <div class="col-md-12">
                <div class="card card-success">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            {!! Form::open([ 'route' => ['web.ads.update', $data['ad']->PK_NO], 'method' => 'post', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('position') ? 'error' : '' !!}">
                                        <div class="controls">
                                            {!! Form::label('position','Ad Position ID <span>*</span>', ['class' => 'label-title'], false) !!}
                                            {!! Form::select('position', $data['positions'] ?? [], old('position', $data['ad']->F_AD_POSITION_NO), ['class'=>'form-control','data-validation-required-message' => 'This field is required', 'placeholder'=>'Ad Position']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('status') ? 'error' : '' !!}">
                                        <div class="controls">
                                            ...
                                            {!! Form::select('status', $status, old('status', $data['ad']->STATUS),array('class'=>'form-control area','data-validation-required-message' => 'This field is required', 'placeholder'=>'Select Status')) !!}
