...
@section('title') {{ __('Listing Price') }} @endsection

@section('page-name') {{ __('Listing Price') }} @endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('Listing Price') }}</li>
@endsection
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Listing Price') }}</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                {!! Form::open([
                                    'route' => 'admin.listing_price.update',
                                    'method' => 'post',
                                    ...
                                    @foreach ($data as $key => $item)
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group {!! $errors->has('gl_sale_price') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::text('gl_sale_name' . $key, $item->name, [
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {!! $errors->has('gl_sale_price') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::text('gl_sale_price' . $key, $price->sell_price, [
                                                            'class' => 'form-control mb-1',
                                                            'placeholder' => 'Price',
                                                            'tabindex' => 1,
                                                        ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {!! $errors->has('gl_rent_price') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::text('gl_rent_price' . $key, $price->rent_price, [
                                                            'class' => 'form-control mb-1',
                                                            'placeholder' => 'Price',
                                                            'tabindex' => 1,
                                                        ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {!! $errors->has('gl_roommate_price') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::text('gl_roommate_price' . $key, $price->roommat_price, [
                                                            'class' => 'form-control mb-1',
                                                            'placeholder' => 'Price',
                                                            'tabindex' => 1,
                                                        ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {!! $errors->has('gl_duration') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::text('gl_duration' . $key, $item->duration, [
                                                            'class' => 'form-control mb-1',
                                                            'placeholder' => 'Price',
                                                            'tabindex' => 1,
                                                        ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('apv_sale_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('apv_sale_price', $data2->agent_prop_view_sales_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('apv_rent_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('apv_rent_price', $data2->agent_prop_view_rent_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('apv_roommate_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('apv_roommate_price', $data2->agent_prop_view_roommate_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('ac_sale_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('ac_sale_price', $data2->agent_comm_sales_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('ac_rent_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('ac_rent_price', $data2->agent_comm_rent_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('ac_roommate_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('ac_roommate_price', $data2->agent_comm_roommate_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('lv_sale_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('lv_sale_price', $data2->lead_view_sales_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('lv_rent_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('lv_rent_price', $data2->lead_view_rent_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group {!! $errors->has('lv_roommate_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('lv_roommate_price', $data2->lead_view_roommate_price ?? 0, [
                                                        'class' => 'form-control mb-1',
                                                        'placeholder' => 'Price',
                                                        'tabindex' => 1,
                                                    ]) !!}
