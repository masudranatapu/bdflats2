...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"> {{ __('Payment Method') }} </a></li>
    <li class="breadcrumb-item active">{{ __('Home Article') }}</li>
@endsection
                                            ...
                                            @foreach ($data['rows'] as $key => $row)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        {{ $row->is_active == 1 ? 'Active' : 'Inactive' }}</td>
                                                    <td class="text-center">
                                                        <a href="{{ route('admin.payment_method.edit', ['id' => $row->id]) }}" class="btn btn-info">
                                                            {{ __('Edit') }}
                                                        </a>
                                                    </td>
                                                </tr>
