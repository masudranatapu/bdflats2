...
@section('title') {{ __('Property Condition | Create') }} @endsection
@section('page-name') {{ __('Property Condition | Create') }} @endsection
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-dashboard">
                                {!! Form::open([
                                    'route' => 'admin.propertycondition.store',
                                    'method' => 'post',
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('property_condition', old('property_condition'), [
                                                    'class' => 'form-control',
