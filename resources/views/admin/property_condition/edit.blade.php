                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-dashboard">
                            {!! Form::open([ 'route' => ['admin.propertycondition.update', $data['condition']->id], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('order_id', old('order_id', $data['condition']->order_id), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Order ID']) !!}
