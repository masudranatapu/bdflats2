                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        @if ($owner->user_type == 2)
                                            <p><span class="font-weight-bold">User Type:
                                                </span>{{ $user_type[$owner->user_type] }}
                                            </p>
                                            <p>
                                            ...
                                            <p><span class="font-weight-bold">Listing Limit:
                                                </span>{{ $owner->listing_limit }}
                                            </p>
                                            <p><span class="font-weight-bold">Total Listing:
                                                </span>{{ $owner->total_listing }}
                                            </p>
                                            ...
                                            <p><span class="font-weight-bold">Payment Auto Renew:
                                                </span>{{ $owner->payment_auto_renew == 1 ? 'Yes' : 'No' }}
                                            </p>
                                            <p><span class="font-weight-bold">Open Time:
                                                </span>{{ $owner->info->shop_open_time ?? 'N/A' }}
                                            </p>
                                            <p><span class="font-weight-bold">Close Time:
                                                </span>{{ $owner->info->shop_close_time ?? 'N/A' }}
                                            </p>
                                            ...
                                            <p><span class="font-weight-bold">Feature Type:
                                                </span>{{ $owner->is_feature == 1 ? 'Feature' : 'General' }}
                                            </p>
                                            <div class="row">
                                                <div class="col-md-3">
                                            ...
                                            <p><span class="font-weight-bold">Actual Topup:
                                                </span>{{ number_format($owner->actual_topup, 2) }}
                                            </p>
                                            <p><span class="font-weight-bold">Pending Topup:
                                                </span>{{ number_format($owner->pending_topup, 2) }}
                                            </p>
                                            <p><span class="font-weight-bold">Unused Topup:
                                                </span>{{ number_format($owner->unused_topup, 2) }}
                                            </p>
                                        @else
                                            <p><span class="font-weight-bold">User Type:
                                                </span>{{ $user_type[$owner->user_type] }}
                                            ...
                                            <p><span class="font-weight-bold">Contact Person Name:
                                                </span>{{ $owner->contact_per_name }}
                                            </p>
                                            ...
                                            <p><span class="font-weight-bold">About Company:
                                                </span>{{ $owner->info->about_company ?? 'N/A' }}
                                            </p>
                                            <p><span class="font-weight-bold">Contact Person Name:
                                                </span>{{ $owner->contact_per_name ?? 'N/A' }}
                                            </p>
                                            <p><span class="font-weight-bold">Payment Auto Renew:
                                                </span>{{ $owner->payment_auto_renew == 1 ? 'Yes' : 'No' }}
                                            </p>
                                            ...
                                            <p><span class="font-weight-bold">Meta Title:
                                                </span>{{ $owner->info->meta_title ?? 'N/A' }}
                                            </p>
                                            <p><span class="font-weight-bold">Site URL:
                                                </span>{{ $owner->info->site_url ?? 'N/A' }}
                                            </p>
                                            <p><span class="font-weight-bold">Meta Description:
                                                </span>{{ $owner->info->meta_description ?? 'N/A' }}
                                            </p>
                                        @endif
                                    </div>
                                    <div class="col-12">
                                        <a href="{{ route('admin.owner.list') }}" class="btn btn-info" style="border-radius: 0;">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
