                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="m-0">{{ __('Owner recharge list') }}</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <h3 class="font-weight-bold">BDT {{ number_format($data['owner']->unused_topup ?? 0, 2) }}</h3>
                                    </div>
                                    {!! Form::open(['route' => ['admin.owner.recharge', $data['owner']->id],'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="{{ route('admin.owner.payment', request()->route('id'))}}">
