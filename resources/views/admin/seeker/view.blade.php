    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('View Property Seeker') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('View Property Seeker') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="m-0">{{ __('View Property Seeker') }}</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="d-block">User ID:
                                                        <strong>{{ $data->code }}</strong></label>
                                                    <label>Created Date:
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p><span class="font-weight-bold">Address: </span>{{ $data->address ?? 'N/A' }}
                                                </p>
                                                <p><span class="font-weight-bold">Mobile:
                                                    </span>{{ $data->mobile_no ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <h2 class="mb-2 mt-2">Property Requirements</h2>
                                                <p><span class="font-weight-bold">City/Division:
                                                    </span>{{ $cities[$row->f_city_no ?? 0] ?? 'N/A' }}</p>
                                            ...
                                            <div class="col-12">
                                                <p><span class="font-weight-bold">Property Looking For:
                                                    </span>{{ ucwords($row->property_for ?? '') }}</p>
                                                <p><span class="font-weight-bold">Property Type:
                                                    </span>{{ $property_types[$row->f_property_type_no ?? 0] ?? 'N/A' }}</p>
                                                <p><span class="font-weight-bold">Property Size: </span>Min:
                                                    {{ $row->min_size ?? 'N/A' }} Max: {{ $row->max_size ?? 'N/A' }}</p>
                                                <p><span class="font-weight-bold">Property Budget: </span>Min:
                                                    {{ $row->min_budget ?? 'N/A' }} Max: {{ $row->max_budget ?? 'N/A' }}</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <p><span class="font-weight-bold">Preferred Time to Contact:
                                                    </span>{{ $row->prep_cont_time ?? 'N/A' }}</p>
                                                <p><span class="font-weight-bold">Email Alert:
                                                    </span>{{ ucwords($row->email_alert ?? 'N/A') }}</p>
                                                <p><span class="font-weight-bold">Verification Status:
                                                    </span>{{ $row && $row->is_verified == 1 ? 'Valid' : ($row && $row->is_verified == 2 ? 'Invalid' : 'Pending') }}
                                                </p>
                                                <p><span class="font-weight-bold">Account Status:
                                                    </span>{{ $user_status[$data->status] ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
