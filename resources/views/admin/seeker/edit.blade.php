                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Created Date:
                                                    <strong>{{ date('M d, Y', strtotime($user->created_at)) }}</strong></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('address') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('address', $user->address ?? old('address'), [
                                                        'class' => 'form-control',
                                                        'placeholder' => 'Address',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('mobile') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('mobile', $user->mobile_no ?? old('address'), [
                                                        'class' => 'form-control',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('city') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::select('city', $cities, $row->f_city_no ?? null, [
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {!! $errors->has('area') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::select('area[]', $areas ?? [], json_decode($row->f_areas ?? null), [
                                                        'class' => 'form-control select2',
                                                        'id' => 'area',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'multiple',
                                            ...
                                            <div class="form-group {!! $errors->has('itemCon') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::radio(
                                                        'itemCon',
                                                        'sale',
                                                        !empty($row) ? ($row->property_for == 'sale' ? true : false) : old('itemCon'),
                                                        ['id' => 'sell', 'data-validation-required-message' => 'This field is required', 'tabIndex' => ++$tabIndex],
                                                    ) !!}
                                                    {{ Form::label('sell', 'Buy') }}
                                                    &emsp;
                                                    {!! Form::radio(
                                                        'itemCon',
                                                        'rent',
                                                        !empty($row) ? ($row->property_for == 'rent' ? true : false) : old('itemCon'),
                                                        ['id' => 'roommate', 'tabIndex' => ++$tabIndex],
                                                    ) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('property_type') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::select('property_type', $property_types, !empty($row) ? $row->f_property_type_no : null, [
                                                        'id' => 'property-type',
                                                        'class' => 'form-control',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('minimum_size') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::number('minimum_size', !empty($row) ? $row->min_size : old('minimum_size'), [
                                                        'id' => 'minimum_size',
                                                        'class' => 'form-control',
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('maximum_size') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::number('maximum_size', !empty($row) ? $row->max_size : old('maximum_size'), [
                                                        'id' => 'maximum_size',
                                                        'class' => 'form-control',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('minimum_budget') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::number('minimum_budget', !empty($row) ? $row->min_budget : old('minimum_budget'), [
                                                        'id' => 'minimum_budget',
                                                        'max' => '',
                                                        'data-validation-max-message' => 'Minimum Budget may not be greater than Maximum Budget',
                                                        'tabIndex' => ++$tabIndex,
                                                        'class' => 'form-control',
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('maximum_budget') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::number('maximum_budget', !empty($row) ? $row->max_budget : old('maximum_budget'), [
                                                        'id' => 'maximum_budget',
                                                        'class' => 'form-control',
                                                ...
                                                <div class="controls">
                                                    <label for="any">
                                                        {!! Form::checkbox(
                                                            'rooms[]',
                                                            'any',
                                                            !empty($bedrooms) ? (in_array('any', $bedrooms) ? true : false) : old('rooms'),
                                                            ['id' => 'any', 'class' => 'form-check-input', 'tabIndex' => ++$tabIndex],
                                                        ) !!}
                                                        Any
                                                    ...
                                                    <label for="1bed">
                                                        {!! Form::checkbox(
                                                            'rooms[]',
                                                            '1',
                                                            !empty($bedrooms) ? (in_array('1', $bedrooms) ? true : false) : old('rooms'),
                                                            ['id' => '1bed', 'class' => 'form-check-input', 'tabIndex' => ++$tabIndex],
                                                        ) !!}
                                                        1
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <label for="2bed">
                                                        {!! Form::checkbox(
                                                            'rooms[]',
                                                            '2',
                                                            !empty($bedrooms) ? (in_array('2', $bedrooms) ? true : false) : old('rooms'),
                                                            ['id' => '2bed', 'class' => 'form-check-input', 'tabIndex' => ++$tabIndex],
                                                        ) !!}
                                                        2
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <label for="3bed">
                                                        {!! Form::checkbox(
                                                            'rooms[]',
                                                            '3',
                                                            !empty($bedrooms) ? (in_array('3', $bedrooms) ? true : false) : old('rooms'),
                                                            ['id' => '3bed', 'class' => 'form-check-input', 'tabIndex' => ++$tabIndex],
                                                        ) !!}
                                                        3
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <label for="4plus">
                                                        {!! Form::checkbox(
                                                            'rooms[]',
                                                            '4',
                                                            !empty($bedrooms) ? (in_array('4', $bedrooms) ? true : false) : old('rooms'),
                                                            ['id' => '4plus', 'class' => 'form-check-input', 'tabIndex' => ++$tabIndex],
                                                        ) !!}
                                                        4 +
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    ...
                                                    @foreach ($data['cond'] as $key => $cond)
                                                        <label for="{{ str_replace(' ', '-', strtolower($cond)) }}">
                                                            {!! Form::checkbox(
                                                                'condition[]',
                                                                $key . ',' . $cond,
                                                                !empty($bedrooms) ? in_array($key, $prop_cond) : old('condition'),
                                                                ['id' => str_replace(' ', '-', strtolower($cond)), 'class' => 'form-check-input'],
                                                            ) !!}
                                                            {{ $cond }}
                                                            <span class="checkmark"></span>
                                                        </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {!! $errors->has('requirement_details') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::textarea(
                                                        'requirement_details',
                                                        !empty($row) ? $row->requirement_details : old('requirement_details'),
                                                        [
                                                            'rows' => '6',
                                                            'maxlength' => '1000',
                                                            'data-validation-maxlength-message' => 'Requirement Details may not be greater than 1000 characters',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('time') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::text('time', !empty($row) ? $row->prep_cont_time : old('time'), [
                                                        'id' => 'time',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    {!! Form::number(
                                                        'max_sharing_permission',
                                                        !empty($row) ? $row->max_sharing_permission : old('max_sharing_permission'),
                                                        [
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    {!! Form::number('lead_price', !empty($row) ? $row->lead_price : old('lead_price'), [
                                                        'id' => 'lead_price',
                                                        'class' => 'form-control',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'placeholder' => 'Max Sharing Permission',
                                    ...
                                    <div class="row email-alert">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group {!! $errors->has('apv_sale_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::radio('alert', 'daily', !empty($row) ? ($row->email_alert == 'daily' ? true : false) : old('alert'), [
                                                        'id' => 'daily',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
                                                    ...
                                                    {!! Form::radio(
                                                        'alert',
                                                        'weekly',
                                                        !empty($row) ? ($row->email_alert == 'weekly' ? true : false) : old('alert'),
                                                        ['id' => 'weekly', 'data-validation-required-message' => 'This field is required', 'tabIndex' => ++$tabIndex],
                                                    ) !!}
                                                    ...
                                                    {!! Form::radio(
                                                        'alert',
                                                        'monthly',
                                                        !empty($row) ? ($row->email_alert == 'monthly' ? true : false) : old('alert'),
                                                        ['id' => 'monthly', 'data-validation-required-message' => 'This field is required', 'tabIndex' => ++$tabIndex],
                                                    ) !!}
                                    ...
                                    <div class="row email-alert">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group {!! $errors->has('v_status') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::radio('v_status', '0', !empty($row) ? ($row->is_verified == 0 ? true : false) : old('alert'), [
                                                        'id' => 'pending',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
                                                    {{ Form::label('pending', 'Pending') }}
                                                    {!! Form::radio('v_status', '1', !empty($row) ? ($row->is_verified == 1 ? true : false) : old('alert'), [
                                                        'id' => 'verified',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
                                                    {{ Form::label('verified', 'Valid') }}
                                                    {!! Form::radio('v_status', '2', !empty($row) ? ($row->is_verified == 2 ? true : false) : old('alert'), [
                                                        'id' => 'invalid',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
                                                    ...
                                                    {!! Form::radio('v_status', '3', !empty($row) ? ($row->is_verified == 3 ? true : false) : old('alert'), [
                                                        'id' => 'updated',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group {!! $errors->has('acc_status') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::select('acc_status', $user_status, $user->status ?? null, [
                                                        'class' => 'form-control',
                                                        'id' => 'acc_status',
                                                        'placeholder' => 'Select',
                                                        'data-validation-required-message' => 'This field is required',
                            ...
                            <div class="card-body">
                                {!! Form::open([
                                    'route' => 'admin.listing_lead_price.update',
                                    'method' => 'post',
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'novalidate',
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {!! $errors->has('apv_sale_price') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::radio('property_for', 'individual', old('property_for'), [
                                                        'id' => 'individual',
                                                        'data-validation-required-message' => 'This field is required',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
                                                    ...
                                                    &emsp;
                                                    {!! Form::radio('property_for', 'developer', old('property_for'), [
                                                        'id' => 'developer',
                                                        'tabIndex' => ++$tabIndex,
                                                    ]) !!}
