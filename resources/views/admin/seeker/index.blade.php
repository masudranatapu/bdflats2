...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="#">@lang('customer.breadcrumb_title')</a>
    </li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                {{-- <span class="float-right">
                                    <a href="{{ route('admin.seeker.index') }}" class="btn btn-sm btn-primary">
                                        All Seekers
                                    </a>
                                </span> --}}
                            </div>
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-2 col-md-12">
                                            <div class="form-group {!! $errors->has('lead_status') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::select('lead_status', $lead_status_combo ?? [], request()->query->get('lead_status'), [
                                                        'class' => 'form-control mb-1 ',
                                        ...
                                        <div class="col-lg-2 col-md-12">
                                            <div class="form-group {!! $errors->has('area') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::select('area', $area_combo, request()->query->get('area'), [
                                                        'class' => 'form-control mb-1 ',
                                        ...
                                        <div class="col-lg-2 col-md-12">
                                            <div class="form-group {!! $errors->has('property_type') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::select('property_type', $property_type_combo, request()->query->get('property_type'), [
                                                        'class' => 'form-control mb-1 ',
                                        ...
                                        <div class="col-lg-2 col-md-12 mb-4 mb-lg-0 text-center" style="margin-top: 39px;">
                                            <input type="submit" class="btn btn-info btn-sm px-2" value="Search"
                                                style="border-radius: 0px">
                                            <a class="btn btn-sm btn-primary text-white"
                                                href="{{ route('admin.seeker.index') }}"
