                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-dashboard">
                            {!! Form::open([ 'route' => ['admin.city.update', $row->id], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        {!! Form::label('city_name', 'City Name *', ['class' => 'label-title']) !!}
                                        <div class="controls">
                                            {!! Form::text('city_name', old('city_name', $row->city_name), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'City Name']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('latitude', old('latitude', $row->lat), ['class' => 'form-control', 'placeholder' => 'Latitude']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('longitude', old('longitude', $row->lon), ['class' => 'form-control', 'placeholder' => 'Longitude']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('order', old('order', $row->order_id), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Order']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::select('status', $status ?? [], old('status', $row->is_active), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            {!! Form::select('populate', [1 => 'Populate', 0 => 'Common'], old('populate', $row->is_populated), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required']) !!}
