...
@section('title') {{ __('Create payment account') }} @endsection
@section('page-name') {{ __('Create payment account') }} @endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('payment_method') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::select('payment_method', $data['methods'] ?? [], old('payment_method'), [
                                                    'class' => 'form-control mb-1',
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('status') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::select('status', $data['status'] ?? [], old('status') ?? 1, [
                                                    'class' => 'form-control mb-1',
