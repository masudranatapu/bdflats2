<!--Edit Account modal-->
<div class="modal fade text-left" id="EditAccountname" tabindex="-1" role="dialog" aria-labelledby="brand_name"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::hidden('name', null, [
                'class' => 'form-control mb-1 source_id',
                ...
                <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('bank_name', null, [
                            'class' => 'form-control mb-1 bank_name',
                            'data-validation-required-message' => 'This field is required',
...
<div class="modal fade text-left" id="addEditMethodModal" tabindex="-1" role="dialog" aria-labelledby="method"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('method', null, [
                            'class' => 'form-control mb-1 method_name',
                            'data-validation-required-message' => 'This field is required',
...
<div class="modal fade text-left" id="addEditSourceModal" tabindex="-1" role="dialog" aria-labelledby="source"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('name', null, [
                            'class' => 'form-control mb-1 source_name',
                            'data-validation-required-message' => 'This field is required',
