...
@section('title') {{ __('NearBy Area | Create') }} @endsection
@section('page-name') {{ __('NearBy Area | Create') }} @endsection
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('NearBy Area Create') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('NearBy Area Create') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
