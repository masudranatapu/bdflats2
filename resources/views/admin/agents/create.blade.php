    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Create Agents') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('Create Agents') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-header">
                                <h5 class="m-0">
                                    ...
                                    <span class="float-right">
                                        <a href="{{ route('admin.agents.index') }}" class="text-warning font-weight-bold">
                                            Back
                                        </a>
                                    </span>
                                </h5>
