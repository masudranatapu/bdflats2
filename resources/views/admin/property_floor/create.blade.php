...
@section('name') Floor | Create @endsection
@section('page-name') Floor | Create @endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-dashboard">
                            {!! Form::open([ 'route' => 'admin.propertyfloor.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {!! Form::label('name', 'Name *', ['class' => 'label-name']) !!}
                                        <div class="controls">
                                            {!! Form::text('name', old('name'), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Floor']) !!}
