...
@section('title') {{ __('Floor | Update') }} @endsection
@section('page-name') {{ __('Floor | Update') }} @endsection
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="m-0">
                                    ...
                                    <span class="float-right">
                                        <a href="{{ route('admin.propertyfloor.list') }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body card-dashboard">
                                {!! Form::open([
                                    'route' => ['admin.propertyfloor.update', $data['floor']->id],
                                    'method' => 'post',
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('name', old('name', $data['floor']->name), [
                                                    'class' => 'form-control',
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                {!! Form::number('order_id', old('order_id', $data['floor']->order_id), [
                                                    'class' => 'form-control',
                                                    'data-validation-required-message' => 'This field is required',
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                {!! Form::select('status', $status ?? [], old('status', $data['floor']->is_active), [
                                                    'class' => 'form-control',
                                                    'data-validation-required-message' => 'This field is required',
