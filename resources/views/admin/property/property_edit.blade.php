                        ...
                        <div class="card-body">
                            <div class="saleform-wrapper mt-2">
                                <div class="container">
                                    ...
                                    {!! Form::open([ 'route' => ['admin.property.update', $product->id], 'method' => 'post', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}
                                            ...
                                            <div class="form-group listingType">
                                                <div class="controls">
                                                    @foreach($property_listing_types as $key => $item)
                                                        ...
                                                        {!! Form::radio('listing_type',$item->id, $product->f_listing_type==$item->id?true:false,[ 'id' => 'listing_type'.$item->id,'data-validation-required-message' => 'This field is required', 'tabIndex' => ++$tabIndex]) !!}
