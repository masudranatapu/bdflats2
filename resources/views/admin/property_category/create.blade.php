...
@section('title') {{ __('Create Property Category') }} @endsection
@section('page-name') {{ __('Create Property Category') }} @endsection
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                {!! Form::open([
                                    'route' => 'admin.propertycategory.store',
                                    'method' => 'post',
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {!! $errors->has('body_description') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::textarea('body_description', null, [
                                                    'class' => 'form-control mb-1',
