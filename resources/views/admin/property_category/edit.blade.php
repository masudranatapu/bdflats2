...
@section('title') {{ __('Update Property Category') }} @endsection

@section('page-name') {{ __('Update Property Category') }} @endsection
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="m-0">
                                    ...
                                    <span class="float-right">
                                        <a href="{{ route('admin.propertycategory.list') }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body">
                                {!! Form::open([
                                    'route' => ['admin.propertycategory.update', $category->id],
                                    'method' => 'post',
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('category_name', $category->property_type, [
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('url_slug', $category->url_slug, [
                                                    'class' => 'form-control mb-1',
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {!! $errors->has('meta_description') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::textarea('meta_description', $category->meta_desc, [
                                                    'class' => 'form-control mb-1',
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {!! $errors->has('body_description') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::textarea('body_description', $category->body_desc, [
                                                    'class' => 'form-control mb-1',
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {!! $errors->has('null') ? 'error' : '' !!}">
                                            <label>URL</label>
                                            <div class="controls">
                                                {!! Form::text('url', $category->category_url, [
                                                    'class' => 'form-control mb-1',
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {!! $errors->has('order') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('order', $category->order_id, [
                                                    'class' => 'form-control mb-1',
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                <div class="fileupload @if (!empty($category->img_path)) {{ 'fileupload-exists' }} @else {{ 'fileupload-new' }} @endif "
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                <div class="fileupload @if (!empty($category->icon_path)) {{ 'fileupload-exists' }} @else {{ 'fileupload-new' }} @endif "
                                                    data-provides="fileupload">
                                                    <span class="fileupload-preview fileupload-exists thumbnail"
                                                        style="max-width: 150px; max-height: 120px;">
                                                    ...
                                                    <br>
                                                    <span class="MainToUpload edit-3-color"
                                                        style="font-size: 12px; color: #bf4c4c;">File types jpg,
                                                        png.</span>
                                                </div>
