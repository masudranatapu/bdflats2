                                            ...
                                            <div class="row no-gutters position-relative">
                                                <div class="col-3">
                                                    <div class="leads-bx text-center">
                                                        <a href="{{route('buy-leads-details',$item->id)}}">
                                                ...
                                                <div class="col-9 position-static">
                                                    <div class="leads-info">
                                                        ...
                                                        <h6>{{date('d M, Y',strtotime($item->CREATED_AT))}} <span class="claim"><a href="{{route('buy-leads-details',$item->id)}}" class="float-right">Claim Refund <i
