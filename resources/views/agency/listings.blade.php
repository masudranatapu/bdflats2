                ...
                <div class="col-sm-12 col-md-9">
                    <div class="account-details">
                        ...
                        <div class="new-property">
                            ...
                            <!-- product -->
                            <table class="table table-striped" style="font-family: 'Montserrat-Medium';font-size: 14px">
                                <thead>
                                <tr>
                                    <th>Sl.</th>
                                    <th>PID</th>
                                ...
                                @if($listings->count()>0)
                                    @foreach($listings as $key => $listing)
                                        <tr>
                                            ...
                                            <td width="20%">
                                                <a href="{{ route('agency.listings.edit', $listing->id) }}" class="text-info">Edit</a> |
                                                <a href="{{ route('agency.listings.delete', $listing->id) }}" onclick="return confirm('Are you sure?')"
                                                   class="text-danger">Delete</a>
                                                @if($listing->PAYMENT_STATUS == 0)
                                                    |
                                                    <a href="{{ route('agency.listings.pay', $listing->id) }}" class="text-success">Pay</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
