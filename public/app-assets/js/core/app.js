...
(function (window, document, $) {
  ...
  $('.search_mother_btn').on('click', function (e) {
    var mother_url = $(this).data('url');
    var multiple_select = $(this).data('multiple');

    if(multiple_select == '1' ){
        $('#bulkCheck').show();
    }
    $('#serach_parent_url').val(mother_url);
    $('#multiple_select').val(multiple_select);
  })
  ...
  i18next
    ...
    .init({
      ...
      fallbackLng: "en",
      backend: {
        loadPath: $('#base_url').val()+"/app-assets/data/locales/{{lng}}.json",
      },
      returnObjects: true
    },
      function (err, t) {
